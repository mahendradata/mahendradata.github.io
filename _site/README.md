...
### Setup ruby environment locally using Ubuntu 20.04

Before you can preview the theme locally, you need to setup ruby environment in your computer.

1. Update repository: `sudo apt update`
2. Install necessary libraries: `sudo apt install build-essential`
3. Install ruby: `sudo apt install ruby-full`
4. Set up a gem installation directory for your user account:
...
5. Install json: `gem install json`
5. Install eventmachine: `gem install eventmachine`
